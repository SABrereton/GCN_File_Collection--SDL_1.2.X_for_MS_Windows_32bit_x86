...
32bit x86 compatible system architecture and that use the SDL API and
SDL extention libraries.
...
++ Licencing information ++
    ...
    * Simple DirectMedia Layer (SDL) 1.2.15 & SDL 1.2.X extention libraries *
    ...
    library files which are used by this program are all licenced
